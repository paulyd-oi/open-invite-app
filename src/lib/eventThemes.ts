...
export const EVENT_THEMES: Record<ThemeId, EventThemeTokens> = {
  ...
  chill_hang: {
    ...
    backBgDark: "#1A141E",
    backBgLight: "#FAF5FC",
    pageTintDark: "rgba(171,71,188,0.04)",
    pageTintLight: "rgba(171,71,188,0.02)",
    chipAccent: "#AB47BC",
  },
  dinner_night: {
    label: "Dinner Night",
    ...
    backBgDark: "#1E1A14",
    backBgLight: "#FFFAF5",
    pageTintDark: "rgba(255,152,0,0.04)",
    pageTintLight: "rgba(255,152,0,0.02)",
    chipAccent: "#FF9800",
  },
  game_night: {
    label: "Game Night",
    ...
    backBgDark: "#14141E",
    backBgLight: "#F5F5FF",
    pageTintDark: "rgba(99,102,241,0.04)",
    pageTintLight: "rgba(99,102,241,0.02)",
    chipAccent: "#6366F1",
  },
  worship_night: {
    label: "Worship Night",
    swatch: "🙏",
    gradientTint: "rgba(156,39,176,0.06)",
    vibeLabel: "You're Invited",
    backAccent: "#9C7C63",
    backBgDark: "#1A1816",
    backBgLight: "#FAF8F5",
    pageTintDark: "rgba(156,124,99,0.04)",
    pageTintLight: "rgba(156,124,99,0.02)",
    chipAccent: "#9C7C63",
  },
  ...
  summer_splash: {
    label: "Summer Splash",
    swatch: "🏖️",
    gradientTint: "rgba(0,188,212,0.12)",
    vibeLabel: "You're Invited",
    backAccent: "#00ACC1",
    backBgDark: "#0F1A1E",
    backBgLight: "#F0FBFC",
    pageTintDark: "rgba(0,172,193,0.06)",
    pageTintLight: "rgba(0,172,193,0.03)",
    chipAccent: "#00ACC1",
  },
  fall_harvest: {
    label: "Fall Harvest",
    swatch: "🍂",
    gradientTint: "rgba(230,126,34,0.12)",
    vibeLabel: "You're Invited",
    backAccent: "#D4763B",
    backBgDark: "#1E1610",
    backBgLight: "#FDF6EF",
    pageTintDark: "rgba(212,118,59,0.06)",
    pageTintLight: "rgba(212,118,59,0.03)",
    chipAccent: "#D4763B",
  },
  winter_glow: {
    label: "Winter Glow",
    swatch: "❄️",
    gradientTint: "rgba(100,149,237,0.12)",
    vibeLabel: "You're Invited",
    backAccent: "#6495ED",
    backBgDark: "#101420",
    backBgLight: "#F0F4FF",
    pageTintDark: "rgba(100,149,237,0.06)",
    pageTintLight: "rgba(100,149,237,0.03)",
    chipAccent: "#6495ED",
  },
  game_day: {
    label: "Game Day",
    swatch: "🏈",
    gradientTint: "rgba(76,175,80,0.12)",
    vibeLabel: "Game On",
    backAccent: "#43A047",
    backBgDark: "#101E12",
    backBgLight: "#F0FAF0",
    pageTintDark: "rgba(67,160,71,0.06)",
    pageTintLight: "rgba(67,160,71,0.03)",
    chipAccent: "#43A047",
  },
  birthday_bash: {
    label: "Birthday Bash",
    swatch: "🎂",
    gradientTint: "rgba(255,80,60,0.14)",
    vibeLabel: "You're Invited",
    backAccent: "#FF6B4A",
    backBgDark: "#1E1210",
    backBgLight: "#FFF5F3",
    pageTintDark: "rgba(255,107,74,0.06)",
    pageTintLight: "rgba(255,107,74,0.03)",
    chipAccent: "#FF6B4A",
  },
};
