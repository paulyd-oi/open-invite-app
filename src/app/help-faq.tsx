...
export default function HelpFAQScreen() {
  ...
  const featureSections: FeatureSection[] = [
      ...
      features: [
        ...
        },
        {
          ...
          howItWorks: [
            ...
            "Filter events by category in the feed",
          ],
        },
        {
          ...
          howItWorks: [
            ...
            "Select which days or dates to repeat",
            "All occurrences are created automatically",
            "Edit or cancel individual occurrences as needed",
          ],
        },
        {
    ...
    },
    {
      ...
      features: [
        {
          title: "Create Event Requests",
          description: "Propose hangout ideas and let friends vote before creating the event.",
          howItWorks: [
            "Tap the '+' button and select 'Event Request'",
            "Describe the event idea (dinner, movie night, etc.)",
            "Select friends you want to invite",
            "Optionally suggest dates/times or let friends propose",
            "Send the request to all selected friends",
            "Wait for responses before the event is created",
          ],
        },
        {
          title: "Respond to Requests",
          description: "Accept or decline event requests from friends.",
          howItWorks: [
            "Open the Event Requests section in your feed",
            "Review the proposed event details",
            "Tap 'Accept' if you want to join",
            "Tap 'Decline' if you can't make it",
            "Once all members respond, the event is automatically created",
          ],
        },
        {
          title: "Request Status Tracking",
          description: "Monitor who has responded to your event requests.",
          howItWorks: [
            "Open an event request you created",
            "See each invited friend's response status",
            "Pending, Accepted, or Declined",
            "Send reminders to friends who haven't responded",
            "Event creates when everyone accepts or you manually create it",
          ],
        },
      ],
    },
      ...
      features: [
        {
          ...
          description: "Form small groups for private event sharing and messaging.",
          howItWorks: [
            "Go to Friends tab and tap 'Create Circle'",
            "Name your circle (e.g., 'Weekend Crew', 'Book Club')",
            "Add members from your friends list",
            "Set a circle photo or icon",
            "Circles are like private groups for closer friends",
          ],
        },
        {
          title: "Circle Events",
          description: "Create events visible only to circle members.",
          howItWorks: [
            "Open a circle you're part of",
            "Tap '+' to create a circle-only event",
            "Only circle members can see and RSVP",
            "Perfect for recurring group activities",
          ],
        },
        {
          title: "Circle Messages",
          description: "Chat with your circle members in a group conversation.",
          howItWorks: [
            "Open a circle to access the chat",
            "Send text messages to all members",
            "Discuss plans, share updates, or just chat",
            "All circle members receive notifications",
          ],
        },
        {
          title: "Circle Members",
          description: "Manage who's in your circle.",
          howItWorks: [
            "Open circle settings to see all members",
            "Add new members from your friends",
            "Remove members if needed",
            "Pin important members for quick access",
            "Leave a circle if you no longer want to be part of it",
          ],
        },
      ],
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          description: "Discover trending events among your friend network.",
          howItWorks: [
            "See events with high attendance in your feed",
            "Popular events are highlighted with badges",
      ...
      features: [
        ...
        },
        {
          ...
          howItWorks: [
            ...
            "Higher tiers require more effort to unlock",
          ],
        },
        {
        ...
        },
        {
          ...
          howItWorks: [
            ...
            "Earn badges like 'Social Butterfly' and 'Always There'",
            "Variety bonus for different event types",
          ],
        },
        {
          ...
          howItWorks: [
            ...
            "Longer streaks unlock higher tier badges",
            "Earn 'Streak Master' for multiple concurrent streaks",
            "Don't break streaks to maintain progress",
          ],
        },
      ],
    },
      ...
      features: [
        ...
        },
        {
          ...
          howItWorks: [
            ...
            "Request data export",
            "Delete account if needed (permanent)",
          ],
        },
      ],
    },
