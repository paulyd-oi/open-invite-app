                    ...
                    {groups.length === 0 ? (
                      ...
                      groups.map((group: FriendGroup) => (
                        <Pressable
                          ...
                          style={{ backgroundColor: selectedGroupIds.includes(group.id) ? `${themeColor}15` : isDark ? "#2C2C2E" : "#F9FAFB" }}
                        >
                          <View
                          ...
                          <Text style={{ color: colors.text }} className="flex-1 font-medium">{group.name}</Text>
