...
- Theme Effect Engine V1: ThemeEffectLayer refactored from single-effect POC to configurable engine with per-preset EffectConfig (direction, speed, palette, density, sway, travel distance). worship_night ambient_dust preserved unchanged. winter_glow snowfall added: 28 cool white/ice-blue particles drifting downward with wide 45pt sway, 10-18s cycles, 0.2-0.55 opacity. Event detail only. useReducedMotion guard. pointerEvents none. No new dependencies (react-native-reanimated only).
