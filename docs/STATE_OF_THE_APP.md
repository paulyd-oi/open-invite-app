...
- Theme Effect Canvas Blend V1.1: Transition gradient moved outside atmospheric zone, uses marginBottom -80 for zero net layout space (was 150px block element pushing content down). Gradient is now a visual overlay (80px, canvasColor→transparent, pointerEvents none, zIndex 1) that fades over the first 80px of content below the card. ThemeEffectLayer particle fade reduced from 150px to 80px. Content returns to pre-blend position.
