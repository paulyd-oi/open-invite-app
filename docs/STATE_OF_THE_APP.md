...
- Theme Effect Canvas Blend V1: Canvas-to-background transition gradient expanded from 60px linear to 150px eased multi-stop (hold canvasColor 20%, transition 20-75%, hold system bg 75-100%). ThemeEffectLayer gets Skia alpha Mask with LinearGradient that fades particles to transparent over the bottom 150px. Removes visible hard stop and grey opacity slab. Particles now drift through the full themed atmosphere and fade naturally at the transition zone.
