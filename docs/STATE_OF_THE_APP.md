...
## Stable
- refetchOnMount: false Sweep V1: Removed the `refetchOnMount: false` anti-pattern from 8 queries across 4 files (friends.tsx, social.tsx, calendar.tsx, usePaginatedFriends.ts). Same root cause as Discover/friend-request stale data bugs. All queries retain staleTime + placeholderData. Intentionally kept on _layout.tsx (auth), AnnouncementBanner.tsx, UpdateBanner.tsx.
